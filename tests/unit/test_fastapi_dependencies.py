...
from musigree.app.fastapi_dependencies import get_redis_client, rate_limiter
...
class TestRedisClient:
    ...
    def test_get_redis_client_initialization(self) -> None:
    ...
    def test_redis_client_configuration(self) -> None:
...
class TestRateLimiter:
    ...
    async def test_rate_limiter_allows_within_limit(
        ...
        mock_response: Mock,
        fresh_redis_client: fakeredis.FakeStrictRedis,
    ) -> None:
    ...
    async def test_rate_limiter_different_clients(
        self, mock_response: Mock, fresh_redis_client: fakeredis.FakeStrictRedis
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_different_endpoints(
        self, mock_response: Mock, fresh_redis_client: fakeredis.FakeStrictRedis
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_handles_no_client(
        self, mock_response: Mock, fresh_redis_client: fakeredis.FakeStrictRedis
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiter_headers_countdown(
        self,
        mock_request: Request,
        mock_response: Mock,
        fresh_redis_client: fakeredis.FakeStrictRedis,
    ...
    async def test_rate_limiter_redis_error_handling(
        self, mock_request: Request, mock_response: Mock
    ) -> None:
        ...
        with patch(
            "musigree.app.fastapi_dependencies.get_redis_client",
    ...
    def test_rate_limiter_factory_different_limits(self) -> None:
