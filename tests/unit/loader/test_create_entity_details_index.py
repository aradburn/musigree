...
class TestCreateEntityDetailsIndex:
    ...
    async def test_create_entity_details_index_success(
        ...
        mock_loader_instance.loader_create_entity_details_index.assert_called_once_with(expected_path)
    ...
    def test_main_execution(self) -> None:
        ...
        with patch("musigree.loader.create_entity_details_index.PostgresDevelopmentConfiguration") as mock_config_class:
            with patch('musigree.loader.create_entity_details_index.asyncio.run') as mock_asyncio_run:
