...
def test_cluster_property_setter():
    ...
    # Test setting cluster with float (should convert to int)
    node.cluster = 7.8
    assert node.cluster == 7


def test_missing_property_setter():
    ...
    # Test setting missing with float (should convert to int)
    node.missing = 5.7
    assert node.missing == 5


def test_subgraph_size_property_setter():
    ...
    # Test setting subgraph_size with float (should convert to int)
    node.subgraph_size = 15.9
    assert node.subgraph_size == 15


def test_entity_key_property():
...
def test_missing_by_page_property():
...
def test_json_representation_with_optional_fields():
...
def test_json_representation_without_optional_fields():
...
def test_complex_parentage_calculation():
    """Test parentage calculation with multiple levels of parents."""
    # Create entities
    entity1 = RuntimeEntity(
        id=1, entity_id=1, entity_type=EntityType.ARTIST, entity_name="Entity One",
        entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
    )
    entity2 = RuntimeEntity(
        id=2, entity_id=2, entity_type=EntityType.ARTIST, entity_name="Entity Two",
        entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
    )
    entity3 = RuntimeEntity(
        id=3, entity_id=3, entity_type=EntityType.ARTIST, entity_name="Entity Three",
        entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
    )
    entity4 = RuntimeEntity(
        id=4, entity_id=4, entity_type=EntityType.ARTIST, entity_name="Entity Four",
        entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
    )
...
def test_complex_neighbors_calculation():
    """Test neighbors calculation with all types of relationships."""
    # Create entities
    entities = []
    for i in range(1, 6):
        entities.append(RuntimeEntity(
            id=i, entity_id=i, entity_type=EntityType.ARTIST, entity_name=f"Entity {i}",
            entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
        ))
...
def test_get_neighbors_empty_relationships():
...
def test_get_parentage_no_parents():
...
def test_children_siblings_parents_properties():
    ...
    other_entity = RuntimeEntity(
        id=2, entity_id=2, entity_type=EntityType.ARTIST, entity_name="Other",
        entities={}, relation_counts={}, entity_metadata={}, genres="Rock", styles="Pop", countries="USA"
    )
