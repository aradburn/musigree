...
class TestRuntimeEntityRepository:
    ...
    async def test_get_by_id_not_found(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_get_by_id_success(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_count_by_type_success(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_count_by_type_non_integer_error(self, mock_execute):
    ...
    async def test_update_success(self):
        ...
        try:
            # WHEN
            result = await self.repository.update(entity_id, payload)
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_get_by_entity_id_and_entity_type_not_found(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_get_by_entity_id_and_entity_type_success(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_get_by_type_and_name_not_found(self, mock_execute):
    ...
    @pytest.mark.asyncio
    @patch.object(RuntimeEntityRepository, 'execute')
    async def test_get_by_type_and_name_success(self, mock_execute):
    ...
    @pytest.mark.asyncio
    async def test_get_entity_id_by_entity_type_and_entity_name_success(self):
    ...
    @pytest.mark.asyncio
    async def test_get_id_by_entity_type_and_entity_name_success(self):
