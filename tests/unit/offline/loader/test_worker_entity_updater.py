...
class TestWorkerEntityUpdater:
    ...
    @patch(
        "musigree.offline.loader.worker_entity_updater.OfflineDatabaseManager.get_concurrency_count"
    )
    @patch(
        "musigree.offline.loader.worker_entity_updater.OfflineDatabaseHelper.initialize"
    )
