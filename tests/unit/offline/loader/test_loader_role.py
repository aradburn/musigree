...
class TestLoaderRole:
    ...
    @patch('musigree.offline.loader.loader_role.INSTRUMENTS_DATA_FILENAMES', ['test_instruments.csv'])
    ...
    def test_load_wikipedia_instruments_success(
        ...
        from musigree.library.fields.role_type import RoleType
        with patch.object(RoleType, 'hornbostel_sachs_to_subcategory', return_value=RoleType.Subcategory.STRINGED_INSTRUMENTS), \
             patch.object(RoleType, 'category_names', {RoleType.Category.INSTRUMENTS: "Instruments"}), \
             patch.object(RoleType, 'subcategory_names', {RoleType.Subcategory.STRINGED_INSTRUMENTS: "String Instruments"}):
    ...
    def test_load_roles_from_files_success(
        ...
        # Mock CSV data
        mock_rows = [
            {"name": "Guitar", "category": "INSTRUMENTS", "subcategory": "STRINGED_INSTRUMENTS"}
        ]
        mock_dict_reader.return_value = mock_rows
