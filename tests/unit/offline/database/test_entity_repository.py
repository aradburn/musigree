...
class TestEntityRepository:
    ...
    async def test_get_ids_success(
        ...
        with patch.object(EntityRepository, '_session', new_callable=PropertyMock) as mock_session_prop:
    ...
    async def test_get_by_entity_id_and_entity_type_success(
        ...
        with patch.object(entity_repository, '_get_one_by_query') as mock_get_one:
            ...
            # Act
            result = await entity_repository.get_by_entity_id_and_entity_type(entity_id, entity_type)
