...
class TestFindRole:
    ...
    def test_find_role_with_word_breakdown(self, mock_find_role_inner: Mock) -> None:
        ...
        def mock_find_role_inner_func(role_name: str):
...
class TestFindRoleInner:
    ...
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataAccess.substitute_role_alternatives')
    ...
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataAccess.substitute_role_alternatives')
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataAccess.role_name_lookup')
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataAccess.role_name_fuzzy_lookup')
...
class TestSubstituteRoleAlternatives:
    ...
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataUtils')
    def test_substitute_role_alternatives_case_insensitive(self, mock_role_data_utils: Mock) -> None:
    ...
    @patch('musigree.offline.data_access_layer.role_data_access.RoleDataUtils')
    def test_substitute_role_alternatives_empty_alternatives(self, mock_role_data_utils: Mock) -> None:
...
class TestLoadAllRolesIntoCache:
    ...
    async def test_load_all_roles_into_cache_success(
        self, mock_log: Mock, mock_role_repository_class: Mock, 
        mock_transaction: Mock, mock_role_cache: Mock, mock_role: Mock
    ) -> None:
        ...
        mock_repository.all.return_value.__aiter__ = AsyncMock(return_value=iter([mock_role]))
    ...
    async def test_load_all_roles_into_cache_multiple_roles(
        self, mock_role_repository_class: Mock, mock_transaction: Mock, mock_role_cache: Mock
    ) -> None:
