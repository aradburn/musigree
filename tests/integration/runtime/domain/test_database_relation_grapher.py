...
@pytest.mark.asyncio
async def test___call___01(reset_database):
    """
...
@pytest.mark.asyncio
async def test___call___02(reset_database):
...
@pytest.mark.asyncio
async def test___call___03(reset_database):
    # GIVEN
    entity_type = EntityType.ARTIST
    entity_name = "Justin Fletcher"
...
@pytest.mark.asyncio
async def test___call___04(reset_database):
    """
    ...
    async with runtime_transaction():
        entity_repository = RuntimeEntityRepository()
        relation_repository = RuntimeRelationRepository()
        artist = await entity_repository.get_by_entity_id_and_entity_type(
...
@pytest.mark.asyncio
async def test___call___05(reset_database):
