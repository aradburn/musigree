...
export const onboardingTourSteps: StepType[] = [
    {
        ...
        content: (
            <div className="h4 mb-0">
                ...
                <p>This short tour shows how to explore the connections.</p>
            </div>
        ),
        position: "center",
        padding: { popover: [0, 0] },
    },
    {
        ...
        content: (
            <div className="h4 mb-0">
                <p>Search for artists, bands, or labels.</p>
                <p>
                    Select a result to visualize the network of connections to
                    other artists, bands and labels.
                </p>
            </div>
        ),
        position: "bottom",
        ...
        content: (
            <div className="h4 mb-0">
                ...
                <p>
                    ...
                    the background to pan around the network.
                </p>
                <p>
                    <i className="bi bi-zoom-in fs-3"></i> &nbsp;&nbsp;Zoom in
                    or &nbsp;&nbsp;
                    <i className="bi bi-zoom-out fs-3"></i> &nbsp;&nbsp;Zoom out
                    by using the mouse-wheel.
                </p>
                <p>
                    <i className="bi bi-diagram-3 fs-3"></i>{" "}
                    &nbsp;&nbsp;Double-click nodes to recentre the network on
                    that node.
                </p>
            </div>
        ),
