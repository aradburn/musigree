...
class MasterTable(OfflineBase):
    """
    Represents the 'master' table in the offline_database.
    ...
    Attributes:
        ...
        artists (Mapped[list]): Information about the artists involved
            in the master. Stored as a JSON object.
        genres (Mapped[list]): The musical genres associated with the
            master. Stored as a JSON object.
        styles (Mapped[list]): The musical styles associated with the
            master. Stored as a JSON object.
        videos (Mapped[list]): Information about videos associated with
            the master. Stored as a JSON object.
        images (Mapped[list]): Information about images associated with
            the master. Stored as a JSON object.
    """
    ...
    """
    videos: Mapped[list[dict[str, Any]] | None] = mapped_column(type_=JSON, nullable=True)
    """
    ...
    """
    images: Mapped[list[dict[str, Any]] | None] = mapped_column(type_=JSON, nullable=True)
    """
    ...
    def __repr__(self) -> str:
        """
        Returns a string representation of the master table object.
